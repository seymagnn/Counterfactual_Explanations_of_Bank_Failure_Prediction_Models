...
write.csv(oversamp_test_results, "oversamp_combined_results.csv", row.names = FALSE)
...
write.csv(oversamp_summary_metrics, "oversamp_summary_metrics.csv", row.names = FALSE)
