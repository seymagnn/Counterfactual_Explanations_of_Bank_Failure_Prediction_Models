...
under_all_cfactuals_ext$Used_Model <- rep("Extratrees", nrow(under_all_cfactuals_ext))
...
under_all_cfactuals_rf$Used_Model <- rep("Randomforest", nrow(under_all_cfactuals_rf))
...
save(undersamp_whatif_results, file = "undersamp_whatif_results.rda")

# MOC Results #

under_moc_cfactuals_ext$CE_Method <- rep("MOC", nrow(under_moc_cfactuals_ext))
under_moc_cfactuals_ext$Used_Model <- rep("Extratrees", nrow(under_moc_cfactuals_ext))
...
under_moc_cfactuals_rf$Used_Model <- rep("Randomforest", nrow(under_moc_cfactuals_rf))

undersamp_moc_results <- rbind(under_moc_cfactuals_ext, under_moc_cfactuals_dt, under_moc_cfactuals_rf, fill = TRUE)
save(undersamp_moc_results, file = "undersamp_moc_results.rda")


# NICE Results #

under_nice_cfactuals_ext$CE_Method <- rep("NICE", nrow(under_nice_cfactuals_ext))
under_nice_cfactuals_ext$Used_Model <- rep("Extratrees", nrow(under_nice_cfactuals_ext))
...
under_nice_cfactuals_rf$Used_Model <- rep("Randomforest", nrow(under_nice_cfactuals_rf))

undersamp_nice_results <- rbind(under_nice_cfactuals_ext, under_nice_cfactuals_dt, under_nice_cfactuals_rf, fill = TRUE)
save(undersamp_nice_results, file = "undersamp_nice_results.rda")
